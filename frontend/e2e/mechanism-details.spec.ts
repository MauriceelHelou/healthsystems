...
test.describe('Mechanism Evidence and Quality', () => {
  ...
  test('should display evidence quality rating', async ({ page }) => {
    const evidenceQuality = page.locator(
      '.evidence-quality, [data-evidence], text=/Evidence Quality|Grade/i'
    );
  ...
  test('should show number of studies', async ({ page }) => {
    const studyCount = page.locator(
      'text=/\\d+ studies/i, .study-count, [data-studies]'
    );
  ...
  test('should show moderators when available', async ({ page }) => {
    const moderators = page.locator(
      'text=/Moderators/i, .moderators, [data-moderators]'
    );
  ...
  test('should display structural competency notes', async ({ page }) => {
    const notes = page.locator(
      'text=/Structural Competency/i, .structural-notes, .competency-notes'
    );
...
test.describe('Mechanism Details Metadata', () => {
  ...
  test('should show spatial variation', async ({ page }) => {
    const spatialVar = page.locator(
      'text=/Spatial Variation/i, .spatial-variation, [data-spatial]'
    );
  ...
  test('should show temporal variation', async ({ page }) => {
    const temporalVar = page.locator(
      'text=/Temporal Variation/i, .temporal-variation, [data-temporal]'
    );
  ...
  test('should display timestamps', async ({ page }) => {
    const timestamps = page.locator(
      'text=/Created|Updated/i, time, .timestamp, [datetime]'
    );
