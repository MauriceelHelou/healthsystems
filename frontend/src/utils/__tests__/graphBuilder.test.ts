...
import type { Mechanism, SystemsNetwork, Category } from '../../types/mechanism';
...
describe('graphBuilder', () => {
  describe('buildGraphFromMechanisms', () => {
    ...
    it('should filter by category', () => {
      ...
      expect(graph.nodes).toHaveLength(4); // node1, node2, node3, node4 - all connected via economic edges
    });
